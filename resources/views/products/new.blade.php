...
<body >
 ...
 <div id="contents">
    <div class="container container-fluid">       
		...
		<div class="row">				
			<div class="col-md-12">		
				<form method="post" action="/product/create" class="formsubmit">
					...
					<div class="form-group">
					    ...
					    <textarea class="form-control" name="origin">{{old('origin')}}</textarea> 
					</div>
					<div class="form-group">
					    <label for="pwd">Destination :</label>
					    <textarea class="form-control" name="destination">{{old('destination')}}</textarea> 
					</div>
					<div class="form-group">
