...
<body >
 ...
 <div id="contents">
    <div class="container container-fluid">            	
		...
		<div class="row">	
			<div class="col-md-8">
				<form action="/transaction/laporan" method="get">				
			...
			<div class="col-md-4">				
				<a href="javascript:void(0)" val-url="/transaction/laporan/excel?{{$parameter}}" class="btn exportexcel">Export to Excel</a> |
				<a href="javascript:void(0)" val-url="/transaction/laporan/pdf?{{$parameter}}" class="btn exportpdf">Export to PDF</a> 				
			</div>
		</div>
		<br/>
